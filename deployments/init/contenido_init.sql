...
\restrict 59CxA3Th3spWDd3aT6cPSyhMrzQS06S1C0TkRCEsmokGl94VLRTqBdeNksxguMp
...
COPY public.albums (id, artist_id, label_id, title, release_date, cover_url) FROM stdin;
...
1	1	1	A Night at the Opera	1975-11-21	https://m.media-amazon.com/images/I/71nxRqKGA8L.jpg
2	2	2	Back in Black	1980-07-25	https://upload.wikimedia.org/wikipedia/commons/9/92/ACDC_Back_in_Black.png
\.
...
COPY public.artists (id, name, description, genre, user_id) FROM stdin;
1	Queen	Legendary British rock band	Rock	\N
2	AC/DC	Legendary Australian hard rock band formed in Sydney	Hard Rock	\N
...
COPY public.tracks (id, album_id, title, genre, duration, file_url, published_at) FROM stdin;
...
\unrestrict 59CxA3Th3spWDd3aT6cPSyhMrzQS06S1C0TkRCEsmokGl94VLRTqBdeNksxguMp
